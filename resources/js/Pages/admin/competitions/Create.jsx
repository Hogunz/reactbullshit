...
export default function Create() {
    ...
    return (
        <>
            <Head title="Add Competition Entry" />
            <NavBar />
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl sm:text-3xl font-extrabold text-dark dark:text-light">
                                    Add Competition / <span className="text-purple">Achievement</span>
                                </h1>
                                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                                    Publish a hackathon, contest, or student competition story to the Hall of Fame.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        name="title"
                                        placeholder="e.g. 1st Place Champion at National Cyber Challenge"
                                        value={data.title}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g. PSITE Regional IT Olympiad 2026"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    <div className="flex items-center justify-between">
                                        ...
                                        <span className="text-[11px] text-gray-400 font-medium">Optional / Flexible</span>
                                    </div>
                                    <input
                                        type="text"
                                        name="award"
                                        placeholder="e.g. Champion, 1st Runner Up, Finalist, or Leave Blank"
                                        value={data.award}
                                        onChange={(e) => setData("award", e.target.value)}
                                        className="w-full mt-1.5 px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple/50 focus:outline-none"
                                    />
                                    <p className="text-[11px] text-gray-400 mt-1">Leave empty if the event had no ranking/placements.</p>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        name="team_members"
                                        placeholder="e.g. John Doe (BSIT), Jane Smith (BSCS), Alex Lee"
                            ...
                            <div>
                                ...
                                <textarea
                                    name="content"
                                    rows="5"
                                    placeholder="Write a brief story or overview about the project, the challenge tackled, and the team's journey..."
                                    value={data.content}
                            ...
                            <div className="flex items-center justify-end gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                                ...
                                >
                                    {processing ? "Saving..." : "Publish to Hall of Fame"}
                                </button>
                            </div>
                        </form>
                    </div>
